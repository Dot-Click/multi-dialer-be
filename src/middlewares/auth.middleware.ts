...
// type User = Awaited<ReturnType<typeof prisma.user.findUnique>> & { role: string };
// declare global {
//   namespace Express {
//     interface Request {
//       user?: User;
...
//       const user = await prisma.user.findUnique({
//         where: { id: apiKeyHeader },
//         select: { id: true, fullName: true, email: true, role: true, image: true, emailVerified: true, createdAt: true, updatedAt: true },
//       });
