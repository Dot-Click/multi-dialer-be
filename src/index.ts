...
app.use(
  cors({
    origin: ["http://localhost:5000", "https://multi-dialer-fe.vercel.app", "https://slingvo-fe-production.up.railway.app", "https://app.slingvo.com", "https://slingvo-agent-ai-dialer.vercel.app", "http://localhost:3000", "http://localhost:3001", "http://localhost:5173"],
    credentials: true,
